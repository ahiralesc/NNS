...
parser.add_argument('-rmcc', nargs='?', default=-1, help='Remove control characters: ')
parser.add_argument('-rmpc', nargs='?', default=-1, help='Remove punctuation characters: ')
parser.add_argument('-rmnc', nargs='?', default=-1, help='Remove numeric characters: ')
parser.add_argument('-rmsc', nargs='?', default=-1, help='Remove special characters: ')
